...
| `dottie/index.html` | Dottie: the platform, scout, the router (one-point-perspective diagram), System One (Choice / Score / Noul), dottie-os, the hive, and an honest status ledger |
